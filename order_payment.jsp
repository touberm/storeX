  ...
  <body id='payment' class='order'>
    <div class="mui-content">
      ...
      <div class="nav mui-clearfix">
        ...
        <div class="unit mui-pull-left mui-text-center">
          <a href="javascript:void(0);" class='on'>待付款
            <span class="bottom"></span></a>
        </div>
        <div class="unit mui-pull-left mui-text-center">
          <a href="javascript:void(0);" class=''>待收货
            <span class="bottom"></span></a>
        </div>
        <div class="unit mui-pull-left mui-text-center">
      ...
      <ul class="mui-table-view mui-table default ">
        <li class="mui-table-view-cell unit">
          <div class="top mui-clearfix line">
             <a href="javascript:void(0);" class="choice mui-pull-left"></a>
          ...
          <div class="operate mui-text-right line">
            <button class="more btn mui-btn">更多</button>
            <button class="cancel btn mui-btn">取消订单</button>
            <button class="other btn mui-btn">朋友代付</button>
            <button class="d red btn mui-btn">付款</button>
          </div>
        </li>
        <li class="mui-table-view-cell unit">
          <div class="top mui-clearfix line">
            <a href="javascript:void(0);" class="choice mui-pull-left"></a>
            <span class="storeName mui-pull-left">手串工坊<span>&nbsp;&gt;</span></span>
            <span class="stat mui-pull-right">等待买家付款</span>
          </div>
          <div class="mid mui-table">
            <div class='table-row'>
              <div class="view mui-table-cell">
          ...
          <div class="operate mui-text-right line">
            ...
            <button class="cancel btn mui-btn">取消订单</button>
            <button class="other btn mui-btn">朋友代付</button>
            <button class="pay red btn mui-btn">付款</button>
          </div>
        </li>
        <li class="mui-table-view-cell unit">
          <div class="top mui-clearfix line">
